...
常见供应商包括 [Gibco](<../番外/试剂厂商/Gibco.md>)、[Sigma](<../番外/试剂厂商/Sigma.md>)/[Merck](<../番外/试剂厂商/Merck.md>)、[STEMCELL Technologies](<../番外/试剂厂商/STEMCELL Technologies.md>)。选择时看物种来源、apo/holo 状态、铁饱和度、是否 recombinant、是否无菌和内毒素水平。
