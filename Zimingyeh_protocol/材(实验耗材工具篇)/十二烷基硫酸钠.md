...
常见供应商包括 [Bio-Rad](<../番外/试剂厂商/Bio-Rad.md>)、[Thermo Scientific](<../番外/试剂厂商/Thermo Scientific.md>)、[Merck](<../番外/试剂厂商/Merck.md>)/[Sigma](<../番外/试剂厂商/Sigma.md>)。用于电泳时选择 electrophoresis grade（电泳级）或 molecular biology grade（分子生物学级），并记录是粉末还是 10% 溶液。
