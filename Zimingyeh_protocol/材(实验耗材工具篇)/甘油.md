...
常见供应商包括 [Merck](<../番外/试剂厂商/Merck.md>)/[Sigma](<../番外/试剂厂商/Sigma.md>)、[Thermo Scientific](<../番外/试剂厂商/Thermo Scientific.md>)、[Bio-Rad](<../番外/试剂厂商/Bio-Rad.md>)。分子生物学和蛋白实验优先选择 molecular biology grade 或 electrophoresis-suitable grade；用于细胞或微生物保存时注意无菌和内毒素要求。
